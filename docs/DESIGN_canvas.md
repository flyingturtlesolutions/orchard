...
| **GD-7b** | rich blocks ref-resolved: `image`/typed-embed sourced from TRUSTED artifacts (`attachment:<id>`/`capture:<id>`) — tab (data URI) first, gdoc `insertInlineImage` behind a signed-URL hop | ⚠ live |
