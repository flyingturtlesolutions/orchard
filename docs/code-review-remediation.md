...
**Change:** bind imports fillOpFor; workflows imports normalizeGoalLabel; extract `_demandForGround`/`_groundSubstrate` in sg.js; move invocation handlers + truncate into shared.js (or a shared events module); tighten `_PLACEHOLDER_RE`.
