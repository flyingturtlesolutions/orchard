...
import { buildDecisionRegExp } from './Core/decisionMarkers.js';   // CW-3a — the decisions-view filter derives from the manifest
...
const _DECISION_RE = buildDecisionRegExp();   // CW-3a (DESIGN_cloud_logs.md ruling 8) — DERIVED from Core/decisionMarkers.js, the ONE manifest (the hand-list this replaced is invariant #1 history: add markers THERE, this and the fleet metric filters both follow)
