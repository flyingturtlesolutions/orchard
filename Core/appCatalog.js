...
const PRESETS = [
  ...
  },
  {
    ...
    description: 'Work your warranty queue across VendorSuite, Zendesk, Shopify, and HubSpot — one detail per homeowner, correlated across systems.',
    defaultConfig: { writePolicy: 'gated' },
    sites: [
