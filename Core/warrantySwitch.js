...
export const EXTRACT_STEPS = [
  ...
  '   supply — a receptacle or outlet, a breaker, or non-electrical work — is OTHER_TRADE. A FIXTURE is only',
  '   OTHER_TRADE when the note names the fixture itself as the faulty device ("the porch light fixture is',
  '   cracked"); a light that flickers, stays on, or will not turn off is a SWITCH fault and is SIMPLE_ROCKER.',
  '',
