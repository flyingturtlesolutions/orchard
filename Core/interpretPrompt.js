...
const SYSTEM = [
  ...
  '- "clarify": the ask is unclear, malformed, or you are not confident — ASK instead of guessing (set "question").',
  '- "teach": the ask needs a capability not in the catalog and not a primitive — offer to be shown.',
  '- "answer": a question/reflection with nothing to run — you will reason in prose.',
  '',
  'RULES:',
  ...
  '- "confidence" (0..1) rates your decision. If the ask is malformed or ambiguous (a fragment, a typo, e.g.',
